...
int main(int argc, char *argv[])
{
	...
	char *path = "../two/data"; // the data *.txt files are under this folder
	char *filetowrite = "../two/result/filetowrite.txt"; // the frequency of all alphabetical letters will be written in this file
